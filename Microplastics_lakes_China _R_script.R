...
# ----------------------------------------------------------------------------------------------------
# 1.1 Network analysis based on microplastic community (Extended Data Figure 2a)
...
# ----------------------------------------------------------------------------------------------------
# 1.2 Linear discriminant analysis (LDA) analysis for microplastic polymers (Extended Data Figure 2b)
